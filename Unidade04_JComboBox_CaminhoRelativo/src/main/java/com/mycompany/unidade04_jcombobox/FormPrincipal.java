...
public class FormPrincipal extends javax.swing.JFrame {
    ...
    public FormPrincipal() {
        ...
        icones[3] = new ImageIcon(getClass().getResource(caminho + nomes[3]));
    }
    ...
    private void initComponents() {
        ...
        lblImagens.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/bug1.GIF"))); // NOI18N
    ...
    private void cbImagensItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbImagensItemStateChanged
        lblImagens.setIcon(icones[cbImagens.getSelectedIndex()]);
